        ...
        return (
          <li key={iso}>
            <button
              ...
              className="slot-chip focus-ring min-h-11 w-full rounded-xl bg-white px-2 py-2.5 text-sm font-semibold text-ink ring-1 ring-line hover:ring-mint-deep/40"
